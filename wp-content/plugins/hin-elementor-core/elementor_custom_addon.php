<?php
 /**
 * Plugin Name: Hin Elementor Custom Addon
 * Description: Hin Elementor Custom Addon for pages.
 * Plugin URI:  https://www.codexexpert.com
 * Version:     1.0.0
 * Author:      Spicy
 * Author URI:  https://www.codexexpert.com
 ...
 * @since 1.2.0
 */
final class Elementor_Custom_Addon {
	...
	public function widget_styles() {
		...
		wp_register_style( 'quick_box', plugins_url( 'css/style.css', __FILE__ ) );
...
// Instantiate Elementor_Custom_Addon.
new Elementor_Custom_Addon();
